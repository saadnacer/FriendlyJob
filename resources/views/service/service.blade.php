        ...
        <div class="flex-1 shadow p-4">
            ...
            <div class="max-w-sm rounded overflow-hidden shadow-lg bg-gradient-to-b from-gray-200 to-gray-300">
                ...
                <div class="px-6 py-4">
                    ...
                    <p class="text-gray-900 font-bold text-xl mt-2">Prix :</p> 
                ...
                <div class="px-6 py-4">
                    <span class="inline-block bg-gray-300 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2"></span>
                </div>
            </div>
