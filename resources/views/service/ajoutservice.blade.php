...
<div class="flex items-center justify-center h-screen">
    <div class="flex items-center shadow-lg max-w-lg mx-auto md:flex">
        ...
        <div class="p-4 flex-1 md:flex md:flex-col justify-center">
            <h2 class="text-center text-2xl font-bold text-gray-800 mb-2">ajoute ton service</h2>
            <h3 class="text-center text-2xl font-bold text-gray-800 mb-2">{{ auth()->guard('jobworker')->user()->nom }}</h3>
            <h3 class="text-center text-2xl font-bold text-gray-800 mb-2">{{ auth()->guard('jobworker')->user()->prenom }}</h3>
            <form action="/service/ajout" method="post" enctype="multipart/form-data">
                ...
                <input type="hidden" name="jobworker_id" value="{{ auth()->guard('jobworker')->user()->nom }}">
